...
// // crteate local file
// String filepath =
// "geneviz-java/src/main/java/GVJ/data/RiAB_ragtag_HiC.fasta";
...
// public static void test_sequencesGetAverageLength(Map<String, DNASequence>
// fastaMap) {
...
// double gcContent = getAverageGCpct(fastaMap);
