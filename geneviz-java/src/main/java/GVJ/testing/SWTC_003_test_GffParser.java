...
// * Suffexisex like .t1, .start1, .CDS{1++}, .exon{1++}, .intron{1++}, .stop1
// are
...
// // Returns: A collection (suitable for iteration using Java's "for" loop) of
// all
...
// System.out.println("Selected Features by Group 'ID=jg10174.t1': " +
// selectedFeatures);
...
// Location location = feature.location(); // length , start , end (-ve for
// reverse strand)
// String type = feature.type();
// HashMap<String, String> attributes = feature.getAttributes(); // also
// getAttribute(key)
// System.out.println("Feature " + count + ": seqname=" + seqname + ", group=" +
// group
// + ", location=" + location + ", type=" + type + ", attributes=" +
// attributes);
